...
export const Cards = (): JSX.Element => {
      ...
      return (
        ...
        <div className="mt-[-10] group-hover:mt-[-2] bottom-0 group-hover:text-gray-700 transition-all duration-[0.6s] ease-[fade]">
                <h1 className="px-2 text-sm opacity-0 group-hover:opacity-100 inline-block mr-2 group-hover:bg-blue-200 rounded-lg transition-all duration-[1.3s] ease-[ease]">{classroom.category.toString().replaceAll("'","").replaceAll("[","").replaceAll("]","").replaceAll(","," và ")}</h1>
